...
namespace Insurance_Claim_Settlement_And_Audit_Pipeline_Project
{
    ...
    {
        private readonly HashSet<string> processedClaimIds = new HashSet<string>(StringComparer.OrdinalIgnoreCase);
        ...
        public void ValidateClaim(Claim claim, PolicyService policyService)
        {
            ...
            {
                throw new ClaimException($"Claim '{claim.ClaimId}': PolicyId cannot be empty.");
            }
