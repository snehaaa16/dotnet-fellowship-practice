    ...
    public class AuditService
    {
        ...
        public AuditToken DecodeAuditToken(byte[] binaryData)
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidDataException("Binary audit data contains extra or corrupted data.");
                }
            ...
            catch (IOException)
            {
                throw new InvalidDataException(
                    "Unable to read binary audit data.");
            }
            catch (FormatException)
            {
                throw new InvalidDataException("Binary audit data is invalid.");
            }
        }
